...
def filtered_by_sample_size(num_of_samples=3500, num_of_input_file=0, data_input_file="", data_output_file=""):
...
input_file="./../data.csv"
intermediate_output_file = "./../intermediate_data.csv"
final_output_file = './../final_data.csv'
sample_size = 6000
filtered_by_sample_size(num_of_samples=sample_size, data_input_file=input_file, data_output_file=intermediate_output_file)

# Step 2. Pre-processing data
# get_ipython().run_line_magic('matplotlib', 'inline')

# Read original data
sample_data = pd.read_csv(intermediate_output_file, encoding='utf-8')
...
redudant_position_features = ['CAM', 'CB', 'CDM', 'CF', 'CM', 'LAM', 'LB', 'LCB', 'LCM', 'LDM', 'LF', 'LM', 'LS', 'LW',
                              'LWB']
...
print('Save pre-processed sample data {} to file: {}'.format(sample_data.shape, final_output_file))
export_csv = sample_data.to_csv(final_output_file, index=None, header=True)
